...
public class Canny_Edge_Detector implements PlugIn {
	...
	private ImageProcessor sourceImage2;
	...
	public ImageProcessor process(ImageProcessor imp) {
		sourceImage2 = imp;
		process();
	...
	public void process() {
		width = sourceImage2.getWidth();
		height = sourceImage2.getHeight();
	...
	private void readLuminance() {
		ImageProcessor ip = sourceImage2;
